...
b26.mean_sampling(b26.df2,T_bin,sd)
b46.mean_sampling(b46.df2,T_bin,sd)
...
# get mean and dev in mean
T_bin2 = 3
b26.mean_sampling(b26.df2,T_bin2,sd)
b46.mean_sampling(b46.df2,T_bin2,sd)
out2 = get_dev(b26.df_mean,b46.df_mean)
plt.plot(b26.df_mean['Sample Temperature(K)'].iloc[out2['start_idx']:-1],out2['dev'],label=f'{T_bin2} K Bin')

# get mean and dev in mean
b26.mean_sampling(b26.df2,T_bin3,sd)
b46.mean_sampling(b46.df2,T_bin3,sd)
out2 = get_dev(b26.df_mean,b46.df_mean)
