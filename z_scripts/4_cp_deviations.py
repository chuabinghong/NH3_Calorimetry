...
def import_TRF():
    array = np.loadtxt(ld + 'TF98_cp_all.csv', delimiter=',')
    H2O = 18.01528
    NH3 = 17.03026
...
df_allred = pd.read_csv(ld + 'lit_cp/' + 'allred_1981.csv', header=0)
df_chernenkaya = pd.read_csv(ld + 'lit_cp/' + 'chernenkaya_1971.csv', header=0)
df_fujita = pd.read_csv(ld + 'lit_cp/' + 'fujita_2008.csv', header=0)
df_hildenbrand = pd.read_csv(ld + 'lit_cp/' + 'hildenbrand_1953.csv', header=0)
...
plt.sca(ax[0])
plt.scatter(df_chan['massfrac']*100, dev,marker='s', edgecolors='k', linewidths=.5,label='Chan & Giauque 1964')
plt.sca(ax[1])
plt.scatter(df_chan['T(K)'], dev,marker='s', edgecolors='k', linewidths=.5,label='Chan & Giauque 1964')

dev = calc_dev(df_hildenbrand['T(K)'],df_hildenbrand['massfrac'],df_hildenbrand['cp(J/kgK)'])
plt.sca(ax[0])
plt.scatter(df_hildenbrand['massfrac']*100, dev,marker='d', edgecolors='k', linewidths=.5,label='Hildenbrand & Giauque 1953')
plt.sca(ax[1])
plt.scatter(df_hildenbrand['T(K)'], dev,marker='d', edgecolors='k', linewidths=.5,label='Hildenbrand & Giauque 1953')

dev = calc_dev(df_wrewsky['T(K)'],df_wrewsky['massfrac'],df_wrewsky['cp(J/kgK)'])
plt.sca(ax[0])
plt.scatter(df_wrewsky['massfrac']*100, dev,marker='P', edgecolors='k', linewidths=.5,label='Wrewsky & Kaigorodoff 1924')
plt.sca(ax[1])
plt.scatter(df_wrewsky['T(K)'], dev,marker='P', edgecolors='k', linewidths=.5,label='Wrewsky & Kaigorodoff 1924')

dev = calc_dev(df_chernenkaya['T(K)'],df_chernenkaya['massfrac'],df_chernenkaya['cp(J/kgK)'])
plt.sca(ax[0])
plt.scatter(df_chernenkaya['massfrac']*100, dev,marker='X', edgecolors='k', linewidths=.5,label='Chernenkaya 1971')
plt.sca(ax[1])
plt.scatter(df_chernenkaya['T(K)'], dev,marker='X', edgecolors='k', linewidths=.5,label='Chernenkaya 1971')

dev = calc_dev(df_allred['T(K)'],df_allred['massfrac'],df_allred['cp(J/kgK)'])
plt.sca(ax[0])
plt.scatter(df_allred['massfrac']*100, dev,marker='^', edgecolors='k', linewidths=.5,label='Allred & Wolley 1981')
plt.sca(ax[1])
plt.scatter(df_allred['T(K)'], dev,marker='^', edgecolors='k', linewidths=.5,label='Allred & Wolley 1981')

dev = calc_dev(df_fujita['T(K)'],df_fujita['massfrac'],df_fujita['cp(J/kgK)'])
plt.sca(ax[0])
plt.scatter(df_fujita['massfrac']*100, dev,marker='v', edgecolors='k', linewidths=.5,label='Fujita et al. 2008')
plt.sca(ax[1])
plt.scatter(df_fujita['T(K)'], dev,marker='v', edgecolors='k', linewidths=.5,label='Fujita et al. 2008')

dev = calc_dev(df_prieto['T(K)'],df_prieto['massfrac'],df_prieto['cp(J/kgK)'])
plt.sca(ax[0])
plt.scatter(df_prieto['massfrac']*100, dev,marker='p', facecolor='#e377c2', edgecolors='k', linewidths=.5,label='Fujita et al. 2008')
plt.sca(ax[1])
plt.scatter(df_prieto['T(K)'], dev,marker='p', facecolor='#e377c2', edgecolors='k', linewidths=.5,label='Fujita et al. 2008')
...
plt.scatter(1,1,marker='P', edgecolors='k', linewidths=.5,label='WK24', alpha=0)
plt.scatter(1,1,marker='X', edgecolors='k', linewidths=.5,label='C71', alpha=0)
plt.scatter(1,1,marker='^', edgecolors='k', linewidths=.5,label='AW81', alpha=0)
plt.scatter(1,1,marker='v', edgecolors='k', linewidths=.5,label='F08', alpha=0)
plt.scatter(1,1,marker='p', facecolor='#e377c2',edgecolors='k', linewidths=.5,label='P22', alpha=0)
